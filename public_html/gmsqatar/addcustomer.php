                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                    ...
                                    <input type="hidden" id="inputClientCompany" class="form-control" name="c_id" value="<?php 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="inputClientCompany" class="form-control" name="cus_email" placeholder="Enter Email">
                                    </div>
                                    <div class="form-group">
                                        <!-- <label for="inputClientCompany">GST No(if company or firm<span class="required-text">**</span>):</label> -->
                                        <input type="hidden" id="inputClientCompany" class="form-control" name="c_gst" placeholder="Enter Tax No" onblur="validateGST()">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputClientCompany">Address:<span class="required-text">*</span></label>
                                        <textarea type="text" id="inputClientCompany" class="form-control" name="c_add" value="" placeholder="Enter Address" required></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputClientCompany">Customer Tax No:</label>
                                        <input type="text"  name="c_gst" id="c_gst" placeholder="Customer Tax No" class="form-control" >
                                        </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <a href="createvehicles_jobcard.php" class="btn btn-secondary">Cancel</a>
                                            <input type="submit" name="btn-cus" value="Save Changes" class="btn btn-success float-right">
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script>
    function validateMobileNumber(input) {
        ...
        if (mobileNumber.length === 8) {
            ...
            input.setCustomValidity('WhatsApp number must be 8 digits');
        }
    }
</script>
    <style>
    ...
    <script>
        function validateGST() {
            ...
            if (gstInput === '' || gstPattern.test(gstInput)) {
                ...
                alert('Tax number is valid!');
                return true;
            } else {
                // GST number is invalid
                alert('Invalid Tax number! Please enter a valid GST number or leave it empty.');
                return false;
            }
        }
    </script>
