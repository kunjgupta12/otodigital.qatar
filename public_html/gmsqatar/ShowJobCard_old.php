...
<form method="POST" action="">
      ...
      <div class="col-md-5 col-5" id="customFilter" style="<?php echo (isset($_POST['filter_type']) && $_POST['filter_type'] == 'custom') ? '' : 'display: none;'; ?>">
       <label>Start Date:</label>
       <input type="date" name="from_date" style="padding:5px;" value="<?php echo $_POST['from_date'] ?? ''; ?>">
       <label>End Date:</label>
       <input type="date" name="to_date" style="padding:5px;" value="<?php echo $_POST['to_date'] ?? ''; ?>">
      </div>

      <div class="col-md-4 col-4" id="monthFilter" style="<?php echo (isset($_POST['filter_type']) && $_POST['filter_type'] == 'month') ? '' : 'display: none;'; ?>">
       <label>Month:</label>
