...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Customer Jobcard Approvel </h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title col-md-10">Send Jobcard > <b>Approvel</b></h3>
            ...
            <div class="card-body">
              ...
              <thead>
                  <tr>
                    ...
                    <th class="text-center">Send Approvel</th>
                  </tr>
                </thead>
                <tbody>

                  <?php display_approvel($conn); ?>
                </tbody>
