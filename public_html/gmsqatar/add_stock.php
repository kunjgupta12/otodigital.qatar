...
<!--     *************************     -->
          <form method="post" action="adminFunction.php" enctype="multipart/form-data">
              ...
              <input type="hidden" id="inputClientCompany" class="form-control" name="pid" value="<?php echo $row['id']; ?>">
            ...
            <div class="form-group">
               <div class="row">
                 ...
                 <div class="form-group">
                    ...
                    <input type="number" id="inputClientCompany" class="form-control" name="Stock" value="<?php echo $row['Stock']; ?>" readonly>
                  </div>
                 </div>
                 <div class="col-md-2">
                 <div class="form-group">
                 ...
                 <div class="col-md-5">
                 <div class="form-group">
                    <label for="qty">Add New Quantity :</label>
                    <input type="number" class="form-control" name="Stocknew" value="">
                  </div>
                 </div>
               </div>
            <div>
              ...
              <button type="submit" name="add_stock" class="btn btn-info float-right">Add Stock</button>
            </div>
    <?php }
                    } ?>
