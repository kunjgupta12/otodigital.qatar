        ...
        <section class="container forms">
            <div class="form login">
                <div class="form-content">
                    <header><img src="img/logo-11.png" alt="" style="width:60px;"><br> Mechanic | Login</header>
                    <!-- <div class="form-link">
                        <span><b>NEW USER?</b> <a href="#" class="link signup-link">Click here to Register Here</a></span>
                    </div> -->
                    <form action="mechanicFunction.php" method="POST">
                        <div class="field input-field">
                            <input type="number" placeholder="Mobile No" name="m_mob" class="input">
                        </div>
                        ...
                        <div class="field button-field">
                            <button type="submit" name="btn-log">Login</button>
                        </div>
            ...
            <div class="form forgot-pass">
                <div class="form-content">
                    <header><img src="img/logo-11.png" alt="" style="width:60px;"><br> Mechanic | Forgot Password</header>
                    <form action="mechanicFunction.php" method="POST">
                        <div class="field input-field">
                            <input type="number" placeholder="Mobile No" name="m_mob" class="input">
                        </div>
                        ...
                        <div class="field button-field">
                            <button type="submit" name="btn-forgot">Update Password</button>
                        </div>

                    </form>
                    <div class="line"></div>
                    <div class="form-link">
                        <span>Already have my password? <a href="#" class="link login-link">Login</a></span>
                    </div>
                </div>
            </div>
...
links.forEach(link => {
        link.addEventListener("click", e => {
            ...
            if (link.classList.contains("forgot-pass-link")) {
                ...
                window.location.href = "mechanic_login.php"; // Replace with the actual URL of your login page
            } else {
