        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h1 class="card-title col-md-10"><b>Add Vehicle</b></h1>
              <h3 class="card-title col-md-2"><?php if (isset($_SESSION['msg4'])) {
                                                echo $_SESSION['msg4'];
                                                unset($_SESSION['msg4']);
                                              } ?></h3>
              <!--<a class="btn btn-success float-right" href="addcustomer.php" title="Add Customer">ADD CUSTOMER</a>-->
            </div>
            <!-- /.card-header -->
            <div class="card-body">
