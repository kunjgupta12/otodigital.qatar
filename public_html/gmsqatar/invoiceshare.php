            ...
            <div class="col-12">
              ...
              <div class="invoice p-3 mb-3">
                <div class="row">
                  <div class="col-12">
                    <h4>
                      <img src="<?php echo $garrage['img']; ?>" alt="" style="width: 150px;"> <?php echo $garrage['g_name']; ?>/invoice
                ...
                <div class="row invoice-info">
                  <div class="col-sm-4 invoice-col">
                    <address>
                      ...
                      <?php echo $garrage['g_address']; ?><br>
                      Phone:<?php echo $garrage['g_mob']; ?><br>
                      Email: <?php echo $garrage['g_email']; ?><br>
                      GST: <strong><?php echo $garrage['g_gst']; ?></strong>
                    </address>
                  </div>
                  <div class="col-sm-4 invoice-col">
                    Bill To
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        ...
                        <img src="<?php echo $garrage['qrcode']; ?>" class="img-radius" alt="" style="width: 220px; border-radius:15px;">
